...
{
  logger.log('info','function-->' + connection.threadId + '|' + 'DoSomethingWithLocation');
  var str = jsondata.LC;
  var arr = str.split(',');
  var LAT = arr[2];
  var LNG = arr[3];
...
{
  logger.log('info','function-->' + connection.threadId + '|' + 'DoSomethingWithCalibration');
  var str = '';
  var calnumber = 0;
...
{
  logger.log('info','function-->' + connection.threadId + '|' + 'DoSomethingWithVersion');
  var str = '';
...
{
  logger.log('info','function-->' + connection.threadId + '|' + 'DoSomethingWithSignal');
  var str = '';
...
{
  logger.log('info','function-->' + 'checkbacklog');
