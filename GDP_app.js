...
function handle_database(jsondata,res,req) {
  ...
  pool.getConnection(function(err,connection)
  {
	...
	var query =
            'insert into ddd_dispensor_dispensing_detail(dsd_Entry_Id,ddd_Cal_Value,ddd_Date_Start,ddd_Duration,ddd_Totaliser,ddd_Reading,ddd_FillType,ddd_Tamper,ddd_Date_Created)'+
 ...
 var connection = null;
  ...
  currentID = jsondata.ID;
    if(jsondata.PCK == null)
    {
      ...
      if ((jsondata.CSVR != null) || (jsondata.CPORT != null) || (jsondata.CBOOT != null))
      {

        logger.log('info','busy setting server process')
